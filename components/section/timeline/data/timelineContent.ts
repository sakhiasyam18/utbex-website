...
export const timelineMilestones: TimelineMilestone[] = [
    {
        ...
        story: 'Didirikan di Kalimantan Tengah dengan keyakinan bahwa ide kecil bisa menjadi kekuatan besar.',
        image: '/images/utbex-from-ide-to-impact.avif',
        imageAlt: 'Awal mula UTBEX Indonesia',
    },
    {
        id: 'tl-2016',
        year: '2016',
        ...
        story: 'Lahirnya kaos lukis tanpa tinta — produk pertama di Indonesia yang menggunakan bahan kimia untuk menghilangkan warna dasar pada cotton bamboo.',
        ...
        evidence: [
            { label: 'Lihat Sertifikat', href: '/images/sertifikat-haki-utbex.avif', type: 'certificate' },
        ],
    },
    {
        id: 'tl-2019',
        ...
        story: 'Memulai lagi dari nol di Malang, berjualan di pinggir jalan, membangun kembali dari awal.',
    ...
    },
    {
        ...
        story: 'Juara II UMKM Prestasi Provinsi Jatim — pengakuan pertama di level provinsi.',
    ...
    },
    {
        ...
        story: 'Mewakili Jawa Timur di gelaran MotoGP Indonesia, membawa nama Malang Raya ke panggung internasional.',
    ...
    },
    {
        ...
        story: 'INOTEK Award, Penghargaan Sumpah Pemuda — transformasi dari brand menjadi social enterprise.',
        image: '/images/awarding-inotek-award-ceremony-2023-utbex.avif',
        imageAlt: 'UTBEX menerima INOTEK Award 2023',
        evidence: [
            { label: 'Lihat Sertifikat', href: '/images/awarding-inotek-award-ceremony-2023-utbex.avif', type: 'certificate' },
            { label: 'Lihat Dokumentasi', href: '/images/piagam-penghargaan-utbex-sebagai-media-pemerdaya-generasi-nusantara-terinovatif-utbex.avif', type: 'documentation' },
        ],
    },
];
