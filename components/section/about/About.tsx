  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 sm:px-10 py-24 lg:py-32">
        ...
        {/* Quote block (Gen Z Premium Redesign) */}
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <footer className="flex items-center gap-5 relative">
                {/* Neumorphic User Icon Container */}
                <div className="relative w-14 h-14 rounded-full bg-gradient-to-br from-white/20 to-white/5 backdrop-blur-md border border-white/20 shadow-[inset_0_2px_4px_rgba(255,255,255,0.3),0_4px_16px_rgba(0,0,0,0.2)] flex items-center justify-center flex-shrink-0 group-hover:bg-white/30 transition-all duration-500 group-hover:scale-110 group-hover:shadow-[0_0_24px_rgba(255,255,255,0.4)]">
